  ...
  public val static Document page = new Document("Inference and runtime") [
    ...
    section("Automatic discovery of sparsity patterns") [
      it += '''
        ...
        blocks of unspecified variables), the Blang runtime first constructs a «MATH»l«ENDMATH» list of factors. 
      ...
      it += '''
        Blang then builds from the instantiated Blang model an «EMPH»accessibility graph«ENDEMPH»,  
