...
//    val File latents = createDummyLatentFile()
    Runner.main(
      "--model", "blang.examples.MixtureModel$Builder", 
      "--model.observations.file", dataFile.absolutePath,
      "--mcmc.nIterations", "10000",
      "--mcmc.thinningPeriod", "100"
      )
    return Results.getFileInResultFolder("samples/means.csv")
  }
